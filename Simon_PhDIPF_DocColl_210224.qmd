...
desc2 <- desc[, c("name", "type", "n", "missing", "unique", "mode")]
desc2
...
We decided that the three class solutions. It is the model with the lowest BIC and the highest Entropy. Even if this and the lowest average latent class posterior probability are not as high as we desired, we interpret them as acceptable.

The average latent class posterior probabilities of the three class solution are:
